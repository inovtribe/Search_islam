...
import 'package:Search_Islam/Widgets/custome_dialog.dart';
import 'package:Search_Islam/helpers/provider_helpers.dart';
import 'package:Search_Islam/pages/about_pages.dart';
import 'package:Search_Islam/pages/blog_pages.dart';
import 'package:Search_Islam/pages/calender_pages.dart';
import 'package:Search_Islam/pages/comment_question_screen.dart';
import 'package:Search_Islam/pages/donate_screen.dart';
import 'package:Search_Islam/pages/doya_name_page.dart';
import 'package:Search_Islam/pages/hadis_screen.dart';
import 'package:Search_Islam/pages/kibla_screen.dart';
import 'package:Search_Islam/pages/labbayekallahumma_screen.dart';
import 'package:Search_Islam/pages/location_page.dart';
import 'package:Search_Islam/pages/nearby_mosque_screen.dart';
import 'package:Search_Islam/pages/niyom_models.dart';
import 'package:Search_Islam/pages/ojifa_screen.dart';
import 'package:Search_Islam/pages/para_wise_page.dart';
import 'package:Search_Islam/pages/quran_word_pages.dart';
import 'package:Search_Islam/pages/settings_page.dart';
import 'package:Search_Islam/pages/shomoy_shuchi_page.dart';
import 'package:Search_Islam/pages/sura_list_page.dart';
import 'package:Search_Islam/pages/tasbih_page.dart';
import 'package:Search_Islam/utils/utils.dart';
